...
alias zshaliases='nvim ~/.oh-my-zsh/custom/aliases.zsh'
...
# ALX directories
alias alx='cl ~/Documents/alx-se-repos'
alias alxlow='cl ~/Documents/alx-se-repos/alx-low_level_programming/'
alias alxhigher='cl ~/Documents/alx-se-repos/alx-higher_level_programming/'
